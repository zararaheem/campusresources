...
export const FIELD_DEFS = [
  ...
  { key: 'levels_list', label: 'Levels offered', group: 'Campus identity', multiline: true, example: 'one per line, starting with a dash:\n- Learning Lab (K–1)\n- Level 1 (2–3)' },
  ...
  { key: 'guide_title', label: 'Guide role title', group: 'Key contacts', example: 'Lead Guide (or Head Guide)' },
  { key: 'lead_guide_name', label: 'Lead / Head Guide — name', group: 'Key contacts', example: 'Drew Casebier' },
  { key: 'lead_guide_phone', label: 'Lead / Head Guide — phone', group: 'Key contacts', example: '(530) 400-0730' },
...
// Field values that apply to every campus unless a location overrides them.
// Lets shared text use {{guide_title}} while defaulting to "Lead Guide".
export const DEFAULT_FIELD_VALUES = { guide_title: 'Lead Guide' };
...
- **{{lead_guide_name}}** | {{guide_title}}: {{lead_guide_phone}}
...
**{{guide_title}} Acknowledgment** — I have reviewed this contract with the student and support their commitment to the expectations outlined above.`,
  },
  {
    key: 'attendance',
    group: 'Policies',
...
- Parents are informed by the {{guide_title}}, Dean of Parents, or Head of School
...
- The {{guide_title}}, Dean of Parents, or Head of School calls parents to inform them of the incident.
...
**{{guide_title}}:** The {{guide_title}} is responsible for ensuring that Alpha delivers on its three commitments to every student: love school, learn 2x in 2 hours, and build essential life skills. {{guide_title}}s construct workshop programming for the year, build motivational and behavioral models for their campus, and coach guides to mentor every student.
...
To register, please visit the registration page to create a login. Once your account has been created you can easily access the site from the main Alpha website or the direct ParentSquare link. {{guide_title}}s will keep level sections up-to-date with relevant information for your student's level.`,
  },
  {
...
export const LOCATIONS = [
  {
    ...
    fields: {
      ...
      guide_title: 'Head Guide',
      lead_guide_name: 'Drew Casebier',
  ...
  },
  {
    ...
    fields: {
      ...
      tardy_time: '8:00 a.m.',
      dismissal_time: '3:30 p.m.',
      unattended_release_age: 'nine years of age',
      booster_seat_age: '9',
      head_of_school_name: 'Dr. Tasha Arnold',
      head_of_school_phone: '(224) 550-3103',
      // Remaining campus-physical details (evacuation assembly areas, on-site
      // security, local lead/coordinator contacts) are left for the Nashville
      // team to fill in /admin — we don't invent safety-critical information.
    },
    // Tennessee-specific policy provisions woven into the shared handbook.
    overrides: {
      'about-alpha': {
        title: 'About Alpha',
        body: `Alpha was founded in 2016 in Austin, Texas as a private school that now serves students from pre-kindergarten through high school graduation. Alpha School Nashville currently serves students in {{grades_served}}.

**{{campus_name}}**
{{address}}
Campus contact: admissions.nashville@alpha.school

Alpha School Nashville operates as a Tennessee non-public school. Provisions reflecting Tennessee law and Category V requirements appear throughout this handbook, in the sections to which they apply.
...
### Students learn two times (2x) more in only 2 hours per day.
Alpha students learn twice as much as standard school students while only spending 2 hours per day on academics. We accomplish this through personalized, mastery-based learning, in which our Guides supervise and support each student's technology-enabled instruction. Learning science, technology and AI enable this accelerated learning. In our Learn2Learn workshops students are taught to become self-driven learners. By only having to spend mornings on academics, Alpha frees up afternoons for challenging, ambitious, and exciting project-based learning workshops.
...
Guides are qualified staff with professional backgrounds who coach, mentor and motivate each student. They supervise personalized, technology-supported instruction, hold high standards, and coach students through challenges rather than lecturing from the front of a room. Guides develop each student's growth mindset, learn their interests and passions, and build and deliver the workshops that develop students' limitless life skills.

The 2026–2027 school year begins August 12, 2026, and ends June 4, 2027. The year is separated into five sessions that run approximately seven weeks each. Alpha maintains traditional Thanksgiving and winter breaks.`,
      },
      'check-in-out': {
        title: 'Check-In and Check-Out',
        body: `Student well-being is our primary concern. To help keep students safe and accounted for, we ask families to follow these procedures:

If your child will arrive after the school day begins (**8:00 a.m.**), please notify the campus team via ParentSquare. Students are responsible for checking in with a Guide upon arrival.

When picking up a student early, parents or authorized pickup persons should notify the campus team via ParentSquare of the student's departure. Students may not be released to adults who are not on the authorized pickup list.

To discuss absences, late arrivals, early releases, or changes to authorized pickup persons, please contact the campus team via ParentSquare.`,
      },
      'drop-off-pick-up': {
        title: 'Drop-Off and Pick Up',
        body: `Both drop-off and pick-up run as curbside / drive-through procedures in the school's designated drop-off area. Alpha staff greet students at the car and help them into the building at arrival, and escort students back to their vehicle at dismissal.

Students may be dropped off in the morning up until the **8:00 a.m.** start time. Students may not enter the building before or after school without an adult or Alpha staff member present. Students are considered **tardy after 8:00 a.m.**

Pick-up begins at **3:30 p.m.** for all students. Parents are welcome to park and walk up, or drive through the pick-up line. All students must be picked up by **4:00 p.m.**

Parents may provide written permission for their child to leave campus unattended at the end of the day once the student is **nine years of age**. Parents must notify the school any time their child will leave with someone who is not on the authorized pick-up list. Alpha does not assume responsibility for student safety once students leave campus grounds. Please contact the campus team via ParentSquare for the drop-off / pick-up map and more information.`,
      },
      attendance: {
        title: 'Attendance',
        body: `Students are expected to attend each school day to ensure program continuity. Excessive absences will be addressed by the Head of School when impeding the student's ability to participate in academic programs and workshops. Absences for religious purposes and observances are permitted.

Alpha School Nashville operates on a school calendar that meets Tennessee non-public school requirements, including at least **180 instructional days**. The official attendance day is **8:00 a.m. to 3:30 p.m.**, Monday through Friday, except for holidays, breaks, and other non-instructional days on the school calendar. Attendance is classified as an excused absence, an unexcused absence, a tardy (arrival after 8:00 a.m.), or an early dismissal (departure before 3:30 p.m.).

Activities before or after the official attendance day — including arrival and dismissal supervision, clubs, extended care, and family conferences — are not counted toward the attendance day unless they are part of the approved instructional schedule.

An absence is **excused** when it is supported by a valid reason accepted by the school, such as illness, a medical appointment, religious observance, a family emergency, or another reason approved by school leadership. An absence is **unexcused** when it is not supported by a valid reason, required documentation, or timely parent communication.

Parents are expected to notify the Campus Coordinator of all late arrivals, early dismissals, or absences via ParentSquare. The school notifies families about Tennessee compulsory-attendance expectations and the possibility of truancy interventions after five unexcused absences.

In line with Tennessee compulsory-attendance law, if a student reaches **five unexcused absences** the school will contact the family, review attendance together, identify any barriers, and put reasonable supports in place — such as a parent conference or a written attendance plan. When required by Tennessee law or Tennessee Department of Education guidance, the school reports to the student's district of residence when a student is expelled, truant, or withdraws.

The school maintains attendance records for each student for each day school is in session, including absences, late arrivals, early dismissals, and other attendance exceptions, along with documentation of parent notices, attendance interventions, and significant attendance communications.`,
      },
      'health-services': {
...
For campus-specific arrival, dismissal, and emergency procedures, contact the Nashville campus team via ParentSquare.`,
      ...
      'two-hour-learning': {
        title: '2-Hour Learning',
        body: `Adaptive software allows flexibility and accommodation for absences due to travel and other major life events. 2-Hour Learning is supplemental, staff-supervised academic work that students complete during a temporary absence — for example, travel or a major life event — so they can keep up while away from campus. It is not a separate remote mode of school. Please contact the Campus Coordinator for more information or visit ParentSquare.
...
**2-Hour Learning:** Supplemental, staff-supervised academic work that lets students keep up during a temporary absence from campus. It is not a separate remote mode of school. Additional information can be found on ParentSquare.
...
**Guide:** Guides are qualified staff who coach, mentor and motivate students. They supervise personalized, technology-supported instruction and coach students through daily challenges toward their limitless goals. They are the emotional and motivational support that enforces the high standards Alpha expects of its students.
...
Assessment results help monitor academic growth, support placement, and inform family communication — they are not used as the sole measure of student progress.`,
  ...
  },
  {
    ...
    is_active: true,
    fields: {
      campus_name: 'Alpha - Spyglass',
      city: 'Austin',
      address: '1201 Spyglass Drive, Austin, TX 78746',
      grades_served: 'grades K–8',
      state: 'Texas',
      levels_list: '- Learning Lab (K–1)\n- Level 1 (2–3)\n- Level 2 (4–5)\n- Middle School (6–8)',
      school_start_time: '8:45 a.m.',
      tardy_time: '8:45 a.m.',
      dismissal_time: '3:30 p.m.',
      unattended_release_age: 'nine years of age',
      booster_seat_age: '8',
...
If planning to arrive at Alpha after the school day begins (8:45 a.m.), parents should notify the Campus Coordinator via ParentSquare. Students are responsible for checking in with a Guide upon arrival.

When picking up students early, parents or authorized pickup persons should notify the Campus Coordinator via ParentSquare of student departure. Students may not be released to adults not listed on the authorized pickup list.

To discuss absences, late arrivals, early releases, or changes to authorized pickup persons, parents may call 512-595-0801 or notify the Campus Coordinator via ParentSquare.`,
      },
      'drop-off-pick-up': {
        title: 'Drop-Off and Pick Up',
        body: `Both pick-up and drop-off traffic begins at the Spyglass Drive entrance. Cars pull into the parking lot from Spyglass Drive, drive through the back parking lot, and are greeted by staff at the portico area. A visual map is available on ParentSquare.

Students may be dropped off between 8:15 a.m. and 8:45 a.m. Students may not enter the Alpha building before or after school without an adult or Alpha staff member present. Students are considered tardy after 8:45 a.m.

Pick-up begins at 3:30 p.m. for all students. Parents are welcome to park and walk up to pick students up, or drive through the pick-up line after 3:15 p.m. Students must be picked up by 4:00 p.m.

Parents may provide written permission for their child to leave campus unattended at the end of the day once the student is nine years of age. Parents must notify the school any time their child will leave campus with anyone not already on their authorized pick-up list. Alpha does not assume responsibility for student safety once students leave campus grounds. Please contact the Dean of Parents for additional information.`,
      },
    },
    academic_year: '2026–2027',
    calendar_template: 'A',
  },
  {
    ...
    is_active: true,
    fields: {
      campus_name: 'Alpha - San Francisco',
      city: 'San Francisco',
...
If planning to arrive at Alpha after the school day begins (8:45 a.m.), parents should notify the Lead Guide via ParentSquare. Students are responsible for checking in with a Guide upon arrival.

When picking up students early, parents or authorized pickup persons should notify the Lead Guide via ParentSquare of student departure. Students may not be released to adults not listed on the authorized pickup list.

To discuss absences, late arrivals, early releases, or changes to authorized pickup persons, parents may call 336-456-7071 or notify the Lead Guide via ParentSquare.`,
      },
      'drop-off-pick-up': {
        title: 'Drop-Off and Pick Up',
        body: `Both pick-up and drop-off operate as curbside procedures. Parents and guardians should remain in their vehicles at all times — there is no need to park or get out of the car. Vehicles should pull up to the school-side curb only (not the Safeway side).

Alpha staff members are stationed curbside to greet students at the car door, open doors as needed, and escort students safely into the building. At dismissal, staff escort students from the building to their vehicle and assist with loading before the car departs.

Students may be dropped off between 8:15 a.m. and 8:45 a.m. Students may not enter the Alpha building before or after school without an adult or Alpha staff member present. Students are considered tardy after 8:45 a.m.

Pick-up begins at 3:30 p.m. for all students. Students will not be released to walk to parked cars off campus. All students must be picked up by 4:00 p.m.

Middle School students may use Waymo or other autonomous ride services, provided the vehicle pulls up to the school-side curb and follows all curbside procedures. Pick-ups on the Safeway side are not permitted.

Parents may provide written permission for their child to leave campus unattended at the end of the day once the student is nine years of age. Parents must notify the school anytime their child will leave campus with anyone not listed on their authorized pick-up list. Alpha does not assume responsibility for student safety once students leave campus grounds. Please contact the Campus Coordinator for additional information.`,
      },
    },
    academic_year: '2026–2027',
    calendar_template: 'A',
...
// Austin (Spyglass) and San Francisco also run Calendar A.
LOCATIONS[2].calendar = CALENDAR_A_EVENTS;
LOCATIONS[2].sessions = CALENDAR_A_SESSIONS;
LOCATIONS[3].calendar = CALENDAR_A_EVENTS;
LOCATIONS[3].sessions = CALENDAR_A_SESSIONS;
