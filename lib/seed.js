...
export const LOCATIONS = [
  ...
  },
  {
    ...
    fields: {
      ...
      unattended_release_age: 'twelve years of age',
      booster_seat_age: '9',
      // Campus-physical details (entrance, drop-off zones, evacuation assembly
      // areas, on-site security, local contacts) are left for the Nashville
...
For campus-specific arrival, dismissal, and emergency procedures, contact the Nashville campus team via ParentSquare.`,
      ...
      // Hidden until the Nashville team adds campus-physical details in /admin
      // (drop-off zones & times, entrance, evacuation assembly areas, local
      // contacts). Un-hide from the campus editor once those fields are filled.
      'drop-off-pick-up': { hidden: true },
      'emergency-response': { hidden: true },
    },
    academic_year: '2026–2027',
    calendar_template: 'A',
